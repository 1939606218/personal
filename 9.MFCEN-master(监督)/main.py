...
def get_args_parser():
    ...
    parser.add_argument('--dataset', choices = ['China', 'river'], default = 'river', help = 'dataset to use')
    ...
    parser.add_argument('--ratio', type = float, default = 0.01, help = 'train ratio')
...
if __name__ == '__main__':
    ...
    results = []  # 保存训练结果
    max_search = 6
    args.dataset = 'river'  # Yellow River  Bay_Area  China USA
