...
def main():
    ...
    cfg_test = cfg.test
    in_fea_num, feature_dim, class_num = cfg.model[current_dataset] #in_fea_num为输入数据的通道数
    ...
    # print("pred_trl_label",pred_trl_label)
    # print("pred_tru_label",pred_tru_label)
    # Post processing
    ...
    # print("predict_img", np.unique(predict_img))
    ...
    # 假设 predict_img 是一个Tensor对象
    to_pil = ToPILImage()
    predict_img = to_pil(predict_img)
